...
5. Set a password with this command: $env:ADMIN_PASSWORD="YourStrongPassword123!"
6. Run the application with; python app.py for Windows, or python3 app.py for macOS/Linux
